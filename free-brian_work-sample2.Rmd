...
## Data requirements
In the accompanying GIS folder, you will find a geodatabase that contains all the required data if you would rather conduct the analysis in a GIS software you are more familiar with (see the separate tutorial for ArcGIS and QGIS). You can obtain data for other locations and datasets from the following locations:
...
fiji_mangrove1996 <- sf::st_read(dsn = "C:\\Users\\free\\Desktop\\Atlas_R\\GIS\\ecological", layer = "mangrove1996") %>% sf::st_transform(crs) %>% 
  sf::st_crop(fiji_aoi)

fiji_mangrove2016 <- st_read(dsn = "C:\\Users\\free\\Desktop\\Atlas_R\\GIS\\ecological", layer = "mangrove2016") %>% st_transform(crs) %>%
  st_crop(fiji_aoi)

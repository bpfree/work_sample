...
# scale bar
scalebar_nadogo <- annotation_scale(width_hint = 0.2, # percent of the plot occupied (20%)
                                    pad_x = unit(2.85, "in"), # how much padded from the x=0 position
                                    pad_y = unit(0.05, "in")) # how much padded from the y=0 position

# north arrow
narrow_nadogo <- annotation_north_arrow(height = unit(0.25, "in"), 
                                        width = unit(0.2, "in"),
                                        pad_x = unit(3.9, "in"),
                                        pad_y = unit(0.05, "in"),
...
# map themes
map_theme_nadogo <- theme(axis.text=element_text(size=8),
                          ...
                          legend.position =  c(0.1,0.91), # alternative = bottom
...
map_theme_nadogo_geomorphic <- theme(axis.text=element_text(size=8),
                                     axis.title=element_text(size=10),
                                     plot.title=element_text(size=12),
                                     panel.grid.major = element_line(color = "transparent"), 
                                     panel.grid.minor = element_line(color = "transparent"),
                                     ...
                                     legend.position =  c(0.16,0.84), # alternative = bottom
...
map_theme_nadogo_sediment <- theme(axis.text=element_text(size=8),
                                   axis.title=element_text(size=10),
                                   plot.title=element_text(size=12),
                                   panel.grid.major = element_line(color = "transparent"), 
                                   panel.grid.minor = element_line(color = "transparent"),
                                   ...
                                   legend.position =  c(0.06,0.84), # alternative = bottom
                                   legend.text = element_text(size=4), # text size of the descriptor
                                   legend.background = element_rect(fill = "transparent"), # make the box transparent --> "transparent"
                                   legend.box.background = element_rect(fill = "white", color = "#4C84A2"), # white background with blue border
                                   legend.box.margin = margin(1,1,1,1), # add some space between the box and the text
...
map_theme_nadogo_bathymetry <- theme(axis.text=element_text(size=8),
                                     axis.title=element_text(size=10),
                                     plot.title=element_text(size=12),
                                     panel.grid.major = element_line(color = "transparent"), 
                                     panel.grid.minor = element_line(color = "transparent"),
                                     ...
                                     axis.text.y = element_text(angle = 90, hjust = 0.5),
                                     legend.title = element_text(size = 4), # size of the title
                                     legend.position =  c(0.07,0.84), # alternative = bottom
                                     legend.text = element_text(size=4), # text size of the descriptor
                                     legend.background = element_rect(fill = "transparent"), # make the box transparent --> "transparent"
                                     legend.box.background = element_rect(fill = "white", color = "#4C84A2"), # white background with blue border
                                     legend.box.margin = margin(1,1,1,1), # add some space between the box and the text
...
map_theme_nadogo_survey <- theme(axis.text=element_text(size=8),
                                 axis.title=element_text(size=10),
                                 plot.title=element_text(size=12),
                                 panel.grid.major = element_line(color = "transparent"), 
                                 panel.grid.minor = element_line(color = "transparent"),
                                 ...
                                 axis.text.y = element_text(angle = 90, hjust = 0.5),
                                 legend.title = element_text(size = 6), # size of the title
                                 legend.position =  c(0.08,0.84), # alternative = bottom
                                 legend.text = element_text(size=4), # text size of the descriptor
                                 legend.background = element_rect(fill = "transparent"), # make the box transparent --> "transparent"
                                 legend.box.background = element_rect(fill = "white", color = "#4C84A2"), # white background with blue border
                                 legend.box.margin = margin(1,1,1,1), # add some space between the box and the text

###################################
# Lekutu and Navakasiga Report Maps
###################################
...
# scale bar
scalebar_lekutu <- annotation_scale(width_hint = 0.2, # percent of the plot occupied (20%)
                                pad_x = unit(3.2, "in"), # how much padded from the x=0 position
                                pad_y = unit(0.05, "in")) # how much padded from the y=0 position

# north arrow
narrow_lekutu <- annotation_north_arrow(height = unit(0.25, "in"), 
                                    width = unit(0.20, "in"),
                                    pad_x = unit(4.4, "in"),
                                    pad_y = unit(0.05, "in"),
...
# map themes
map_theme_lekutu <- theme(axis.text=element_text(size=8),
                      ...
                      legend.position =  c(0.12,0.08), # alternative = bottom
...
map_theme_lekutu_geomorphic <- theme(axis.text=element_text(size=8),
                                 axis.title=element_text(size=10),
                                 plot.title=element_text(size=12),
                                 panel.grid.major = element_line(color = "transparent"), 
                                 panel.grid.minor = element_line(color = "transparent"),
...
map_theme_lekutu_sediment <- theme(axis.text=element_text(size=8),
                               axis.title=element_text(size=10),
                               plot.title=element_text(size=12),
                               panel.grid.major = element_line(color = "transparent"), 
                               panel.grid.minor = element_line(color = "transparent"),
                               ...
                               legend.position =  c(0.10,0.15), # alternative = bottom
                               legend.text = element_text(size=4), # text size of the descriptor
                               legend.background = element_rect(fill = "transparent"), # make the box transparent --> "transparent"
                               legend.box.background = element_rect(fill = "white", color = "#4C84A2"), # white background with blue border
                               legend.box.margin = margin(1,1,1,1), # add some space between the box and the text
...
map_theme_lekutu_bathymetry <- theme(axis.text=element_text(size=8),
                                 axis.title=element_text(size=10),
                                 plot.title=element_text(size=12),
                                 panel.grid.major = element_line(color = "transparent"), 
                                 panel.grid.minor = element_line(color = "transparent"),
                                 ...
                                 axis.text.y = element_text(angle = 90, hjust = 0.5),
                                 legend.title = element_text(size = 4), # size of the title
                                 legend.position =  c(0.08,0.15), # alternative = bottom
                                 legend.text = element_text(size=4), # text size of the descriptor
                                 legend.background = element_rect(fill = "transparent"), # make the box transparent --> "transparent"
                                 legend.box.background = element_rect(fill = "white", color = "#4C84A2"), # white background with blue border
                                 legend.box.margin = margin(1,1,1,1), # add some space between the box and the text
...
map_theme_lekutu_survey <- theme(axis.text=element_text(size=8),
                             axis.title=element_text(size=10),
                             plot.title=element_text(size=12),
                             panel.grid.major = element_line(color = "transparent"), 
                             panel.grid.minor = element_line(color = "transparent"),

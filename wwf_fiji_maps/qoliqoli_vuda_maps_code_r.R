###################################
# Vuda & Waya District Report Maps
###################################
...
# scale bar
scalebar_vuda <- annotation_scale(width_hint = 0.2, # percent of the plot occupied (20%)
                                    pad_x = unit(0.30, "in"), # how much padded from the x=0 position
                                    pad_y = unit(0.05, "in")) # how much padded from the y=0 position

# north arrow
narrow_vuda <- annotation_north_arrow(height = unit(0.25, "in"), 
                                        width = unit(0.2, "in"),
                                        pad_x = unit(0.05, "in"),
                                        pad_y = unit(0.05, "in"),
...
# map themes
map_theme_vuda <- theme(axis.text=element_text(size=8),
                          ...
                          legend.position =  c(0.85,0.90), # alternative = bottom
...
map_theme_vuda_geomorphic <- theme(axis.text=element_text(size=8),
                                     axis.title=element_text(size=10),
                                     plot.title=element_text(size=12),
                                     panel.grid.major = element_line(color = "transparent"), 
                                     panel.grid.minor = element_line(color = "transparent"),
                                     panel.background = element_rect(fill = water_col),
                                     axis.text.y = element_text(angle = 90, hjust = 0.5),
                                     legend.title = element_text(size = 5), # size of the title
                                     legend.position =  c(0.78,0.85), # alternative = bottom
...
map_theme_vuda_sediment <- theme(axis.text=element_text(size=8),
                                   axis.title=element_text(size=10),
                                   plot.title=element_text(size=12),
                                   panel.grid.major = element_line(color = "transparent"), 
                                   panel.grid.minor = element_line(color = "transparent"),
...
map_theme_vuda_bathymetry <- theme(axis.text=element_text(size=8),
                                     axis.title=element_text(size=10),
                                     plot.title=element_text(size=12),
                                     panel.grid.major = element_line(color = "transparent"), 
                                     panel.grid.minor = element_line(color = "transparent"),
...
map_theme_vuda_survey <- theme(axis.text=element_text(size=8),
                                 axis.title=element_text(size=10),
                                 plot.title=element_text(size=12),
                                 panel.grid.major = element_line(color = "transparent"), 
                                 panel.grid.minor = element_line(color = "transparent"),

###################################
# Labasa1 (western) District Report Maps
###################################
...
# scale bar
scalebar_Labasa1 <- annotation_scale(width_hint = 0.2, # percent of the plot occupied (20%)
                                   pad_x = unit(2.75, "in"), # how much padded from the x=0 position
                                   pad_y = unit(0.05, "in")) # how much padded from the y=0 position

# north arrow
narrow_Labasa1 <- annotation_north_arrow(height = unit(0.25, "in"), 
                                       width = unit(0.2, "in"),
                                       pad_x = unit(3.88, "in"),
                                       pad_y = unit(0.05, "in"),
...
# map themes
map_theme_Labasa1 <- theme(axis.text=element_text(size=8),
                         ...
                         legend.position =  c(0.90,0.15), # alternative = bottom
...
map_theme_Labasa1_geomorphic <- theme(axis.text=element_text(size=8),
                                    axis.title=element_text(size=10),
                                    plot.title=element_text(size=12),
                                    panel.grid.major = element_line(color = "transparent"), 
                                    panel.grid.minor = element_line(color = "transparent"),
                                    ...
                                    legend.position =  c(0.87,0.28), # alternative = bottom
                                    legend.text = element_text(size=6), # text size of the descriptor
                                    legend.background = element_rect(fill = "transparent"), # make the box transparent --> "transparent"
                                    legend.box.background = element_rect(fill = "white", color = "#4C84A2"), # white background with blue border
                                    legend.box.margin = margin(1,1,1,1), # add some space between the box and the text
...
map_theme_Labasa1_sediment <- theme(axis.text=element_text(size=8),
                                  axis.title=element_text(size=10),
                                  plot.title=element_text(size=12),
                                  panel.grid.major = element_line(color = "transparent"), 
                                  panel.grid.minor = element_line(color = "transparent"),
                                  ...
                                  axis.text.y = element_text(angle = 90, hjust = 0.5),
                                  legend.title = element_text(size = 8), # size of the title
                                  legend.position =  c(0.90,0.26), # alternative = bottom
                                  legend.text = element_text(size=6), # text size of the descriptor
                                  legend.background = element_rect(fill = "transparent"), # make the box transparent --> "transparent"
                                  legend.box.background = element_rect(fill = "white", color = "#4C84A2"), # white background with blue border
                                  legend.box.margin = margin(1,1,1,1), # add some space between the box and the text
...
map_theme_Labasa1_bathymetry <- theme(axis.text=element_text(size=8),
                                    axis.title=element_text(size=10),
                                    plot.title=element_text(size=12),
                                    panel.grid.major = element_line(color = "transparent"), 
                                    panel.grid.minor = element_line(color = "transparent"),
                                    ...
                                    legend.position =  c(0.94,0.23), # alternative = bottom
...
map_theme_Labasa1_survey <- theme(axis.text=element_text(size=8),
                                axis.title=element_text(size=10),
                                plot.title=element_text(size=12),
                                panel.grid.major = element_line(color = "transparent"), 
                                panel.grid.minor = element_line(color = "transparent"),
                                ...
                                axis.text.y = element_text(angle = 90, hjust = 0.5),
                                legend.title = element_text(size = 8), # size of the title
                                legend.position =  c(0.90,0.25), # alternative = bottom
                                legend.text = element_text(size = 6), # text size of the descriptor
                                legend.background = element_rect(fill = "transparent"), # make the box transparent --> "transparent"
                                legend.box.background = element_rect(fill = "white", color = "#4C84A2"), # white background with blue border
                                legend.box.margin = margin(1,1,1,1), # add some space between the box and the text
...
for (i in 1){
  ...
  # x-axis limits
  if(i==1){xbreaks <- seq(179.25,179.45,0.05)} # Labasa1
